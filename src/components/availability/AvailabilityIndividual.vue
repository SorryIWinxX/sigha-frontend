<template>
    <div class="w-full h-full mt-4 text-gray-900 min-h-screen">
                    ...
                    <div class="flex flex-wrap gap-2">
                        <template v-for="areaId in globalAvailability.areas" :key="areaId">
                            ...
                            <span v-if="!showAllSubjects && areasStore.getSubjectsByArea(areaId).length > 3"
                                class="px-3 py-2 bg-gray-100 text-black rounded-full text-xs border border-gray-200">
        ...
        <!-- Table Component -->
        <AvailibilityList active-tab="individual" :selected-professor-data="selectedProfessorData"
