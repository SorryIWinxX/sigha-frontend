    ...
    <div>
        ...
        <div class="relative">
            <input :id="id" :type="type" :value="modelValue" @input="$emit('update:modelValue', $event.target.value)"
                :placeholder="placeholder" :required="required" :disabled="disabled" :readonly="readonly" :class="[
                    ...
                    disabled ? 'bg-gray-100 text-gray-700 cursor-not-allowed' : 'bg-white text-[#3b3e45]',
