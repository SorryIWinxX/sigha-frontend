<template>
    <Layout>
        <div class="flex justify-between items-center pb-4">
            <h1 class="text-2xl font-bold">Horarios de Grupos por Profesor</h1>
            <SemesterSelector @semester-changed="onSemesterChanged" />
        </div>
        <GroupsScheduleTeacher :semester-id="currentSemesterId" />
    </Layout>
</template>
...
import GroupsScheduleTeacher from '@/components/groups/GroupsScheduleTeacher.vue';
