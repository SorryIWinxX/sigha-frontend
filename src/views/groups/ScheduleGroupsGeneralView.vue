<template>
    <Layout>
        <div class="flex justify-between items-center pb-4">
            <h1 class="text-2xl font-bold">Horarios de Escuela</h1>
            <SemesterSelector @semester-changed="onSemesterChanged" />
        </div>
        <GroupsScheduleGeneral :semester-id="currentSemesterId" read-only />
    </Layout>
</template>
...
import GroupsScheduleGeneral from '@/components/groups/GroupsScheduleGeneral.vue';
